...
public class TutorialSparks extends AbstractControl {
    ...
    public TutorialSparks(int numParticles, float radius, SpaceRocks app,
            Vector3f location) {
        this(numParticles, radius, app, location,
                Sparks.SPARK_COL1, Sparks.SPARK_COL2, Sparks.SPARK_COL3);
    }
